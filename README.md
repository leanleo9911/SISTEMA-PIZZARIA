   ...
   1. **Baixe ou clone o projeto** para o seu computador. Recomenda-se salvar a pasta do sistema diretamente na área de trabalho (Desktop) para facilitar o acesso e a execução dos comandos.
